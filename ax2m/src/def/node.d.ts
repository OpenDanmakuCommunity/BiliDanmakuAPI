...
declare var Buffer: {
     ...
     *   If totalLength is not provided, it is read1 from the buffers in the list. However, this adds an additional loop to the function, so it is faster to provide the length explicitly.
     */
    concat(list: Buffer[], totalLength?: number): Buffer;
    /**
...
declare module "fs" {
    ...
    /** Constant for fs.access(). File can be read1 by the calling process. */
